...
function toggleContainerPages(containerWindow, pages)
    containerWindow:getChildById('miniwindowScrollBar'):setMarginTop(pages and 42 or 32)
    containerWindow:getChildById('miniwindowScrollBar'):setMarginBottom(pages and 42 or 3)
