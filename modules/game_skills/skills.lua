...
function init()
    ...
    skillsButton = modules.client_topmenu.addLeftGameButton('skillsButton', tr('Skills') .. ' (Alt+S)', '/images/topbuttons/skills', toggle)
...
function refresh()
    ...
    for i = Skill.Fist, Skill.LifeLeechAmount do
